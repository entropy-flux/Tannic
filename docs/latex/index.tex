...
\end{DoxyCode}
\hypertarget{index_autotoc_md61}{}\doxysection{\texorpdfstring{Status}{Status}}\label{index_autotoc_md61}
...
While the library is currently written in C++23, the arrival of C++26, is shaping up to be a monumental-\/ too significant to ignore. At some point, it may be requirement for Tannic.\hypertarget{index_autotoc_md62}{}\doxysection{\texorpdfstring{Features}{Features}}\label{index_autotoc_md62}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md63}{}\doxysection{\texorpdfstring{What is comming...}{What is comming...}}\label{index_autotoc_md63}
...
\DoxyHorRuler{0}
\hypertarget{index_autotoc_md65}{}\doxysection{\texorpdfstring{Requirements}{Requirements}}\label{index_autotoc_md65}
...
Clone the repository and include {\ttfamily tannic.\+hpp} and build it as follows\+:\hypertarget{index_autotoc_md67}{}\doxysubsection{\texorpdfstring{Debug build\+:}{Debug build:}}\label{index_autotoc_md67}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md68}{}\doxysubsection{\texorpdfstring{Release build}{Release build}}\label{index_autotoc_md68}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md69}{}\doxysubsection{\texorpdfstring{Run the example}{Run the example}}\label{index_autotoc_md69}
You can run the example provided in the main.\+cpp from the build folder\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{./main}

\end{DoxyCode}
\hypertarget{index_autotoc_md70}{}\doxysubsection{\texorpdfstring{Include Tannic in your project}{Include Tannic in your project}}\label{index_autotoc_md70}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ <tannic.hpp>}}

\end{DoxyCode}
\hypertarget{index_autotoc_md71}{}\doxysubsection{\texorpdfstring{CUDA support}{CUDA support}}\label{index_autotoc_md71}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md72}{}\doxysection{\texorpdfstring{License \& Attribution}{License \& Attribution}}\label{index_autotoc_md72}
Tannic is licensed under the {\bfseries{Apache License 2.\+0}}, a permissive open-\/source license that allows you to use, modify, and distribute the code freely—even in commercial projects.
