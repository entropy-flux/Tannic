...
\Hypertarget{index_md_docs_2INDEX}%
 \hypertarget{index_autotoc_md32}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{index_autotoc_md32}
...
\item \href{https://github.com/entropy-flux/llama3-server-example}{\texttt{ LLa\+Ma3 Server Example}} – demonstrates serving Lla\+Ma3 transformer model for text completion tasks.
\end{DoxyItemize}
...
\DoxyCodeLine{\ \ \ \ }
\DoxyCodeLine{\ \ \ \ Y\ =\ log(X)\ +\ Y\ *\ Y\ -\/\ exp(X)\ +\ \mbox{\hyperlink{namespacetannic_a3681656aa208b88dfc79a1806cf669b6}{matmul}}(X,\ Y.transpose());\ \textcolor{comment}{//\ assign\ expressions\ dynamically\ like\ in\ python}}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md34}{}\doxysection{\texorpdfstring{Status}{Status}}\label{index_autotoc_md34}
...
While the library is currently written in C++23, the arrival of C++26, is shaping up to be a monumental, too significant to ignore. At some point, it may be requirement for Tannic.\hypertarget{index_autotoc_md35}{}\doxysection{\texorpdfstring{Features}{Features}}\label{index_autotoc_md35}
...
\item Constexpr templated expressions\+: This allows custom kernel fusion strategies using SFINAE, compile time exceptions and shape calculations.
...
\end{DoxyItemize}\hypertarget{index_autotoc_md36}{}\doxysection{\texorpdfstring{What is comming...}{What is comming...}}\label{index_autotoc_md36}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md37}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_autotoc_md37}
This guide is currently in a “works on my machine” state. If you encounter any issues while building Tannic, your feedback is greatly appreciated, please open an issue or submit a pull request. Contributions to improve this guide are also very welcome!\hypertarget{index_autotoc_md38}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{index_autotoc_md38}
...
Other optional requirements may be added in the future. Also the arrival of C++26, is shaping up to be too significant to ignore. At some point, it may be requirement for Tannic.\hypertarget{index_autotoc_md39}{}\doxysubsection{\texorpdfstring{Clone the repository\+:}{Clone the repository:}}\label{index_autotoc_md39}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md40}{}\doxysubsection{\texorpdfstring{Debug build\+:}{Debug build:}}\label{index_autotoc_md40}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md41}{}\doxysubsection{\texorpdfstring{Release build}{Release build}}\label{index_autotoc_md41}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md42}{}\doxysubsection{\texorpdfstring{Run the example}{Run the example}}\label{index_autotoc_md42}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md43}{}\doxysubsection{\texorpdfstring{Include Tannic in your project}{Include Tannic in your project}}\label{index_autotoc_md43}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ <tannic.hpp>}}

\end{DoxyCode}
\hypertarget{index_autotoc_md44}{}\doxysubsection{\texorpdfstring{CUDA support}{CUDA support}}\label{index_autotoc_md44}
...
These defaults provide a fast setup for development with the current state of the library. As Tannic evolves, CUDA configuration options and behavior may change.\hypertarget{index_autotoc_md45}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{index_autotoc_md45}
...
Functions in Tannic do not immediately compute results. Instead, they build Composable Expression objects, described in detail in the \href{https://entropy-flux.github.io/Tannic/concepts.html}{\texttt{ concepts}} documentation. Basically an {\ttfamily Composable} expression is any class that follows the pattern\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{\textcolor{keyword}{concept\ }Composable\ =\ \textcolor{keyword}{requires}(\textcolor{keyword}{const}\ T\ expression)\ \{}
...
This design also paves the way for future features such as tensor quantization.\hypertarget{index_autotoc_md46}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{index_autotoc_md46}
Contributions to Tannic are welcome! Whether you’re reporting bugs, proposing features, improving documentation, or optimizing kernels, your help is greatly appreciated.\hypertarget{index_autotoc_md47}{}\doxysection{\texorpdfstring{Ways to Contribute}{Ways to Contribute}}\label{index_autotoc_md47}
...
Target branch\+: PRs for now should just target main till the library matures.\hypertarget{index_autotoc_md49}{}\doxysection{\texorpdfstring{Project structure}{Project structure}}\label{index_autotoc_md49}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classtannic_1_1Tensor}{Tensor}}\ W\ =\ \mbox{\hyperlink{namespacetannic_a3681656aa208b88dfc79a1806cf669b6}{matmul}}(X,\ Y)\ +\ Z;}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classtannic_1_1Tensor}{Tensor}}\ W\ =\ \mbox{\hyperlink{namespacetannic_a3681656aa208b88dfc79a1806cf669b6}{matmul}}(X,\ Y)\ +\ Z;}
\DoxyCodeLine{W\ =\ W\ *\ log(Z);}
\DoxyCodeLine{W\ =\ W\ *\ exp(Y)\ +\ X[1];\ }
\DoxyCodeLine{std::cout\ <<\ W[1]\ +\ Z[0];\ \textcolor{comment}{//\ IO\ supported\ for\ expressions.}}

\end{DoxyCode}
\hypertarget{index_autotoc_md51}{}\doxysubsection{\texorpdfstring{License \& Attribution}{License \& Attribution}}\label{index_autotoc_md51}
