...
\Hypertarget{index_md_docs_2INDEX}%
 \hypertarget{index_autotoc_md61}{}\doxysection{\texorpdfstring{Introduction}{Introduction}}\label{index_autotoc_md61}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md63}{}\doxysection{\texorpdfstring{Status}{Status}}\label{index_autotoc_md63}
...
While the library is currently written in C++23, the arrival of C++26, is shaping up to be a monumental-\/ too significant to ignore. At some point, it may be requirement for Tannic.\hypertarget{index_autotoc_md64}{}\doxysection{\texorpdfstring{Features}{Features}}\label{index_autotoc_md64}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md65}{}\doxysection{\texorpdfstring{What is comming...}{What is comming...}}\label{index_autotoc_md65}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md66}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{index_autotoc_md66}
This guide is currently in a “works on my machine” state. If you encounter any issues while building Tannic, your feedback is greatly appreciated, please open an issue or submit a pull request. Contributions to improve this guide are also very welcome!\hypertarget{index_autotoc_md67}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{index_autotoc_md67}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md69}{}\doxysubsection{\texorpdfstring{Debug build\+:}{Debug build:}}\label{index_autotoc_md69}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md70}{}\doxysubsection{\texorpdfstring{Release build}{Release build}}\label{index_autotoc_md70}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md71}{}\doxysubsection{\texorpdfstring{Run the example}{Run the example}}\label{index_autotoc_md71}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md72}{}\doxysubsection{\texorpdfstring{Include Tannic in your project}{Include Tannic in your project}}\label{index_autotoc_md72}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{preprocessor}{\#include\ <tannic.hpp>}}

\end{DoxyCode}
\hypertarget{index_autotoc_md73}{}\doxysubsection{\texorpdfstring{CUDA support}{CUDA support}}\label{index_autotoc_md73}
...
These defaults provide a fast setup for development with the current state of the library. As Tannic evolves, CUDA configuration options and behavior may change.\hypertarget{index_autotoc_md74}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{index_autotoc_md74}
...
This design also paves the way for future features such as tensor quantization.\hypertarget{index_autotoc_md75}{}\doxysection{\texorpdfstring{Contributing}{Contributing}}\label{index_autotoc_md75}
Contributions to Tannic are welcome! Whether you’re reporting bugs, proposing features, improving documentation, or optimizing kernels, your help is greatly appreciated.\hypertarget{index_autotoc_md76}{}\doxysection{\texorpdfstring{Ways to Contribute}{Ways to Contribute}}\label{index_autotoc_md76}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md77}{}\doxysection{\texorpdfstring{How to Contribute}{How to Contribute}}\label{index_autotoc_md77}
...
Target branch\+: PRs for now should just target main till the library matures.\hypertarget{index_autotoc_md78}{}\doxysection{\texorpdfstring{Project structure}{Project structure}}\label{index_autotoc_md78}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md80}{}\doxysubsection{\texorpdfstring{License \& Attribution}{License \& Attribution}}\label{index_autotoc_md80}
