...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \}\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetannic_1_1expression}{tannic::expression}}\ \{\ }
\DoxyCodeLine{00049\ \ }
...
\DoxyCodeLine{00071\ }
\DoxyCodeLine{00072\ }
\DoxyCodeLine{00085\ \textcolor{keyword}{template}<\textcolor{keyword}{class\ }\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Coordinates}},\ \mbox{\hyperlink{concepttannic_1_1Composable}{Composable}}\ ...\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Sources}}>}
...
\DoxyCodeLine{00089\ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ Coordinates,\ Composable\ Source>}
\DoxyCodeLine{00090\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtannic_1_1expression_1_1Complexification}{Complexification}}<\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Coordinates}},\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Source}}>\ \{}
...
\DoxyCodeLine{00102\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float32}}:\ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex64}};\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00103\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float64}}:\ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex128}};\ \textcolor{keywordflow}{break};}
...
\DoxyCodeLine{00109\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{assert}}(source.shape().back()\ ==\ 2\ \&\&\ }
...
\DoxyCodeLine{00120\ \ \ \ \ \}\ }
\DoxyCodeLine{00121\ }
\DoxyCodeLine{00131\ \ \ \ \ \textcolor{keyword}{constexpr}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Complexification_3_01Coordinates_00_01Source_01_4_a2fe6c4fda4d24839fbf8c5dc92ce5d30}{dtype}}()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00182\ \ \ \ \ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ dtype\_;\ }
...
\DoxyCodeLine{00188\ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ Coordinates,\ Composable\ Real,\ Composable\ Imaginary>}
\DoxyCodeLine{00189\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classtannic_1_1expression_1_1Complexification}{Complexification}}<\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Coordinates}},\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Real}},\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Imaginary}}>\ \{}
...
\DoxyCodeLine{00204\ }
\DoxyCodeLine{00205\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (real.dtype()\ ==\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float64}}\ ||\ imaginary.dtype()\ ==\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float64}})\ \{}
\DoxyCodeLine{00206\ \ \ \ \ \ \ \ \ \ \ \ \ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex128}};}
\DoxyCodeLine{00207\ \ \ \ \ \ \ \ \ \}\ }
\DoxyCodeLine{00208\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00209\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00210\ \ \ \ \ \ \ \ \ \ \ \ \ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex64}};}
\DoxyCodeLine{00211\ \ \ \ \ \ \ \ \ \}\ }
\DoxyCodeLine{00212\ \ \ \ \ \}\ }
\DoxyCodeLine{00213\ }
\DoxyCodeLine{00218\ \ \ \ \ \textcolor{keyword}{constexpr}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Complexification_3_01Coordinates_00_01Real_00_01Imaginary_01_4_acff24f7db0995fa5781b69fdfb1987a5}{dtype}}()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00257\ \ \ \ \ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ dtype\_;\ \ }
\DoxyCodeLine{00258\ \};}
\DoxyCodeLine{00259\ }
\DoxyCodeLine{00260\ }
\DoxyCodeLine{00289\ \textcolor{keyword}{template}<Composable\ Source>}
...
\DoxyCodeLine{00302\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex64}}:\ \ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float32}};\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00303\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{case}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{complex128}}:\ dtype\_\ =\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{float64}};\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00304\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{default}:}
\DoxyCodeLine{00305\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{assert}}(\textcolor{keyword}{false}\ \&\&\ }
...
\DoxyCodeLine{00320\ \ \ \ \ \}}
\DoxyCodeLine{00321\ }
\DoxyCodeLine{00331\ \ \ \ \ \textcolor{keyword}{constexpr}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Realification_a0f9bb911a1fc9fa7e5fa8f1c9bf77306}{dtype}}()\textcolor{keyword}{\ const\ }\{\ }
...
\DoxyCodeLine{00375\ \ \ \ \ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{type}}\ dtype\_;}
...
\DoxyCodeLine{00379\ }
\DoxyCodeLine{00380\ }
\DoxyCodeLine{00401\ \textcolor{keyword}{template}<Composable\ Real>}
\DoxyCodeLine{00402\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacetannic_1_1expression_ab9732ede6a977fed3895bf928a67748f}{complexify}}(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Real}}\&\&\ real)\ \{}
\DoxyCodeLine{00403\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Complexification<Cartesian,\ Real>}}\{std::forward<Real>(real)\};}
\DoxyCodeLine{00404\ \}}
\DoxyCodeLine{00405\ }
\DoxyCodeLine{00425\ \textcolor{keyword}{template}<Composable\ Real,\ Composable\ Imaginary>}
\DoxyCodeLine{00426\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacetannic_1_1expression_a79760dbb305bbb78577f24479457c383}{complex}}(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Real}}\&\&\ real,\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Imaginary}}\&\&\ imaginary)\ \{}
\DoxyCodeLine{00427\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Complexification<Cartesian,\ Real,\ Imaginary>}}\{}
\DoxyCodeLine{00428\ \ \ \ \ \ \ \ \ std::forward<Real>(real),\ }
\DoxyCodeLine{00429\ \ \ \ \ \ \ \ \ std::forward<Imaginary>(imaginary)}
\DoxyCodeLine{00430\ \ \ \ \ \};}
\DoxyCodeLine{00431\ \}}
\DoxyCodeLine{00432\ }
\DoxyCodeLine{00452\ \textcolor{keyword}{template}<Composable\ Magnitude,\ Composable\ Angle>}
\DoxyCodeLine{00453\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacetannic_1_1expression_a94ab220f2ca090334605296af5f3de84}{polar}}(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Magnitude}}\&\&\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{rho}},\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Angle}}\&\&\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{theta}})\ \{}
\DoxyCodeLine{00454\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Complexification<Polar,\ Magnitude,\ Angle>}}\{}
\DoxyCodeLine{00455\ \ \ \ \ \ \ \ \ std::forward<Magnitude>(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{rho}}),\ }
\DoxyCodeLine{00456\ \ \ \ \ \ \ \ \ std::forward<Angle>(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{theta}})}
\DoxyCodeLine{00457\ \ \ \ \ \};}
\DoxyCodeLine{00458\ \}}
\DoxyCodeLine{00459\ }
\DoxyCodeLine{00485\ \textcolor{keyword}{template}<Composable\ Complex>}
\DoxyCodeLine{00486\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacetannic_1_1expression_a0e5202d0e8bc3b22deddc6eabcb0df39}{realify}}(\mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Complex}}\&\&\ complex)\ \{}
\DoxyCodeLine{00487\ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classtannic_1_1expression_1_1Comparison}{Realification<Complex>}}\{std::forward<Complex>(\mbox{\hyperlink{namespacetannic_1_1expression_a79760dbb305bbb78577f24479457c383}{complex}})\};}
\DoxyCodeLine{00488\ \}\ }
\DoxyCodeLine{00489\ }
\DoxyCodeLine{00490\ \}\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetannic}{tannic}}\ \{}
\DoxyCodeLine{00491\ \ \ \ \ }
