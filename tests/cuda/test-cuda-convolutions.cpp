...
TEST(TestConvolutionDVC, BigConvDVC) {
...
TEST(BiasedConvolutionDVC, BigBiasedCongDVC) {
    ...
    Tensor b(float32, {1}); b.initialize(Device());
    b[0] = 10;
...
TEST(BiasedConvolutionDVC, BigBiasedConv2OutChannelsDVC) {
    Tensor X(float32, {2,3,4,4});
    ...
    Tensor b(float32, {2}); b.initialize(Device());
