...
/*
TEST(Test, IndexingCUDA) { 
    Tensor x(float32, {1,2,3}, Device(0));
    x[0][0][0] = 1.f;
    x[0][0][1] = 2.f;
    x[0][0][2] = 3.f;
    x[0][1][0] = 4.f;
...
TEST(Test, TransposeNegativeIndicesCUDA) {
    Tensor x(float32, {2, 3}, Device(0));
    x[0][0] = 1.f; x[0][1] = 2.f; x[0][2] = 3.f;
    x[1][0] = 4.f; x[1][1] = 5.f; x[1][2] = 6.f;
...
TEST(Test, SqueezeCUDA) { 
    Tensor x(float32, {1, 3, 1, 2}, Device(0));
...
TEST(Test, UnsqueezeCUDA) {
    // Start with shape {3, 2}
    Tensor x(float32, {3, 2}, Device(0));
    x[0][0] = 1.f; x[2][1] = 5.f;
...
TEST(Test, UnsqueezeNegativeIndicesCUDA) {
    Tensor x(float32, {3, 2}, Device(0));
    x[0][0] = 1.f; x[2][1] = 5.f;
...
TEST(Test, UnsqueezeVariadicCUDA) {
    Tensor x(float32, {3, 2}, Device(0));
    x[0][0] = 1.f; x[2][1] = 5.f;
