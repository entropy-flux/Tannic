...
void Tensor::assign(std::byte const* value, difference_type offset) {     
...
bool Tensor::compare(std::byte const* value, difference_type offset) const { 
