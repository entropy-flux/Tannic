...
status conv2d(const tensor_t*, const tensor_t*, const tensor_t*, tensor_t*, stream_t, const size_t pad[2], const size_t stride[2])  { throw std::runtime_error("CUDA not available"); }
} // namespace cuda
#endif
