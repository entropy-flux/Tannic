...
void matmul_float32_float32(const void*, const void*, void*, size_t, size_t, size_t, bool); 
void matmul_float32_float64(const void*, const void*, void*, size_t, size_t, size_t, bool);
void matmul_float64_float32(const void*, const void*, void*, size_t, size_t, size_t, bool);
void matmul_float64_float64(const void*, const void*, void*, size_t, size_t, size_t, bool);


using Kernel = void(*)(const void*, const void*, void*, size_t, size_t, size_t, bool);
using Kernels = std::array<std::array<Kernel, TYPES>, TYPES>;

constexpr Kernels make_kernels() {
    Kernels kernels{};
    kernels[float32][float32] = matmul_float32_float32;
    kernels[float32][float64] = matmul_float32_float64;
    kernels[float64][float32] = matmul_float64_float32;
    kernels[float64][float64] = matmul_float64_float64;
    return kernels;
}
