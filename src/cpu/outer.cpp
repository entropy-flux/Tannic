...
constexpr auto dispatchOuter = []() {
    ...
    table[index(int32, bfloat16)]  = launchOuterKernel<int32_t, bhalf, float>;
    table[index(bfloat16, int32)]  = launchOuterKernel<bhalf, int32_t, float>;
    ...
    table[index(bfloat16, bfloat16)] = launchOuterKernel<bhalf, bhalf, float>;
    table[index(bfloat16, float32)]  = launchOuterKernel<bhalf, float, float>;
    table[index(bfloat16, float64)]  = launchOuterKernel<bhalf, double, double>;
    table[index(float32, bfloat16)]  = launchOuterKernel<float, bhalf, float>;
    table[index(float64, bfloat16)]  = launchOuterKernel<double, bhalf, double>;
#endif 
